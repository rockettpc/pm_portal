      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs text-emerald-400 bg-emerald-950/80 border border-emerald-800/60 px-2 py-0.5 rounded">
              CGI GLASS SOLUTIONS
            </span>
          </div>
          <button
            onClick={toggleLanguage}
            className="flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800 text-slate-300 text-xs px-2.5 py-1 rounded border border-slate-800 transition"
          >
            <Globe size={14} className="text-emerald-400" />
            <span className="font-semibold uppercase">{i18n.language === 'en' ? 'Español' : 'English'}</span>
          </button>
        </div>

        {/* Login Card */}
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 sm:p-8 shadow-2xl shadow-black/50">
          <div className="text-center mb-6">
            <div className="inline-flex p-3 bg-emerald-600/20 text-emerald-400 rounded-xl border border-emerald-500/30 mb-3">
              <Wrench size={28} />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 bg-slate-950 border border-slate-700 rounded-lg text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-2.5 px-4 bg-emerald-600 hover:bg-emerald-500 text-white font-medium text-sm rounded-lg shadow-lg shadow-emerald-900/30 transition flex justify-center items-center gap-2 disabled:opacity-50"
            >
